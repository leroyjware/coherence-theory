...
\section{Part V: Relation to Classical and Modern Physics}
...
\section{Part VI: Methods, Measurement, and Empirical Roadmap}
...
\begin{enumerate}
    ...
    \item Ware, L. (2025/2026). Ware's Law: Critical Scaling in Stochastic Linear Consensus Dynamics. IEEE Transactions on Artificial Intelligence (submitted).
\end{enumerate}
